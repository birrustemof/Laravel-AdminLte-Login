...
<div class="lockscreen-wrapper">
    <div class="lockscreen-logo">
        <a href="<?php echo e(url('/login.html')); ?>" class="text-decoration-none">AdminLTE</a>
    </div>
    <div class="lockscreen-name">John Doe</div>
    <div class="lockscreen-item">
        <div class="lockscreen-image">
            <img src="<?php echo e(asset('assets/img/user1-128x128.jpg')); ?>" alt="User Image" />
        </div>
    ...
    <div class="text-center">
        <a href="<?php echo e(url('/login.html')); ?>" class="text-decoration-none">Or sign in as a different user</a>
    </div>
...
<?php /**PATH D:\xampp\htdocs\html6up\proje\resources\views/examples/lockscreen.blade.php ENDPATH**/ ?>