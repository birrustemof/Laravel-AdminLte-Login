                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <link rel="stylesheet" href="<?php echo e(asset('css/adminlte.rtl.css')); ?>">
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    How have you been? I was...
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            src="<?php echo e(asset('assets/img/user7-128x128.jpg')); ?>"
                                                            alt="User Avatar"
                                                        />
                                                        <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                                    ...
                                    <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            src="<?php echo e(asset('assets/img/user5-128x128.jpg')); ?>"
                                                            alt="User Avatar"
                                                        />
                                                        <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                                    ...
                                    <small class="contacts-list-date float-end"> 2/10/2023 </small>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            src="<?php echo e(asset('assets/img/user6-128x128.jpg')); ?>"
                                                            alt="User Avatar"
                                                        />
                                                        <div class="contacts-list-info">
                                  <span class="contacts-list-name">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row text-center m-1">
                                            ...
                                            <div class="col-3 p-2">
                                                <img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/img/user4-128x128.jpg')); ?>"
                                                    alt="User Image"
                                                />
                                                <a
                                                    class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                ...
                                <div class="table-responsive">
                                    <table class="table m-0">
                                        ...
                                        <tr>
                                            <td>
                                                <a
                                                    href="<?php echo e(url('pages/examples/invoice')); ?>" 
                                                class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                                >OR9842</a
                                                >
                                            </td>
                            ...
                            <div class="card-body p-0">
                                <div class="px-2">
                                    <div class="d-flex border-top py-2 px-1">
                                        <div class="col-2">
                                            <img
                                                src="<?php echo e(asset('assets/img/default-150x150.png')); ?>"
                                                alt="Product Image"
                                                class="img-size-50"
                                            />
                                        </div>
...
<?php echo $__env->make('main.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\html6up\proje\resources\views/pages/index2.blade.php ENDPATH**/ ?>